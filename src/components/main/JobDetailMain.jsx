        ...
        <div className="main-inner-content-desc">
          <h1 className="main-title">
            ...
            <span className="main-title-num">
              (10 out of 50 application received)
            </span>
          </h1>
          <ul className="main-list">
            ...
            <li>Posted on</li>
            <li className="main-date">
              12/5/2023 <span>2:19 PM</span>
            </li>
          </ul>
          <div className="main-content-details">
            ...
            <div className="main-description">
              ...
              <p>
                An app that makes travel planning easy for real. Get AI
                suggestions for your next trip, and build out full-fledged
                itinerary with features like navigation, hotel hunting, flight
                bookings, etc. The goal is to make the best travel planning app
                out there.
              </p>
            </div>
            ...
            <div className="main-qualification">
              ...
              <p>
                Bsc Statistics, Computer Technology/Computer Systems Technology
              </p>
